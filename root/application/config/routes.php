...
*/
$route['admin'] = 'backend/Index_Controller/index';
...
$route['(:any)/(:any)/(:any)'] = 'Index_Controller/index/$1/$2/$3';
$route['(:any)/(:any)'] = 'Index_Controller/index/$1/$2';
$route['(:any)'] = 'Index_Controller/index/$1';
